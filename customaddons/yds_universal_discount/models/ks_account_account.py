...
class Company(models.Model):
    ...
    ks_enable_discount = fields.Boolean(string="Activate Universal Discount", Default="True")
...
class KSResConfigSettings(models.TransientModel):
    ...
    ks_enable_discount = fields.Boolean(string="Activate Universal Discount", related='company_id.ks_enable_discount', readonly=False, Default="True")
