    ...
    def _compute_yds_untaxed_amount_invoiced(self):
        for line in self:
            if line.untaxed_amount_invoiced == 0:
                ...
                line.yds_untaxed_amount_invoiced = line.untaxed_amount_invoiced - \
                    line.price_subtotal * \
                    (line.order_id.ks_global_discount_rate/100)
    ...
    def _compute_yds_untaxed_amount_to_invoice(self):
        for line in self:
            if line.untaxed_amount_to_invoice == 0:
                ...
                line.yds_untaxed_amount_to_invoice = line.untaxed_amount_to_invoice - \
                    line.price_subtotal * \
                    (line.order_id.ks_global_discount_rate/100)
